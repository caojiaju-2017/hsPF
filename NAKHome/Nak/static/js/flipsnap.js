...
function SelectImgPanel(selector, opts) {
    ...
    var defaultCfg = {
        /**默认的图片*/
        defalutImgUrl: path +/static/images/app/flipsnap/default.png",
        /**每个item宽度*/
        itemWidth: 155,
        /**每个item高度*/
        itemHeight: 61,
    ...
    function buildCtrl() {
        ...
        $this.leftCtrl.custImg = $('span images.custImg', $this.$container);
