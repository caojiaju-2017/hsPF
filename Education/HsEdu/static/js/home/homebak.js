...
$.extend({
    ...
    showResource: function (index) {
        ...
        // 设置背景色
        $("#abc_" + 1).css("color","#fff");
        $("#abc_" + 2).css("color","#fff");
        $("#abc_" + 3).css("color","#fff");
        $("#abc_" + 4).css("color","#fff");
        $("#abc_" + 10).css("color","#fff");

        $("#abc_" + 1).css("background-color","#0DAEFF");
        $("#abc_" + 2).css("background-color","#0DAEFF");
        $("#abc_" + 3).css("background-color","#0DAEFF");
        $("#abc_" + 4).css("background-color","#0DAEFF");
        $("#abc_" + 10).css("background-color","#0DAEFF");

        $("#abc_" + currentType).css("color","#d58512");
        $("#abc_" + currentType).css("background-color","#d0d0d0");
